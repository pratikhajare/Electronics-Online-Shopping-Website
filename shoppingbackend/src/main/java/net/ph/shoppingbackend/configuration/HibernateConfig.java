package net.ph.shoppingbackend.configuration;
...
@Configuration
@ComponentScan(basePackages= {"net.ph.shoppingbackend.dto"})
...
public class HibernateConfig {
	...
	public DataSource getDataSource()
	{
		...
		datasource.setUsername(this.DATABASE_USERNAME);
	...
	//sessionfactory bean will be available
		...
		public SessionFactory getSessionFactory(DataSource dataSource)
		{
			...
			builder.scanPackages("net.ph.shoppingbackend.dto");
		...
		private Properties getHibernateProperties()
		{
			...
			properties.put("hibernate.dialect",this.DATABASE_DIALECT);
